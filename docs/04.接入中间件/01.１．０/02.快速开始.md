...
下载 **Zip** 文件 [https://gitee.com/BTAJL/api-coord/attach_files/901590/download/Interface-Cooperation-Middleware-1.0-SNAPSHOT.zip](https://gitee.com/BTAJL/api-coord/attach_files/901590/download/Interface-Cooperation-Middleware-1.0-SNAPSHOT.zip)
...
* 使用 **wget** 下载 **tar**
  ...
  ```sh
  wget https://gitee.com/BTAJL/api-coord/attach_files/901589/download/Interface-Cooperation-Middleware-1.0-SNAPSHOT.tar
  ```
