...
>  * 下载代码 `middleware` 分支
     >   ``` shell
>   git clone https://gitee.com/BTAJL/api-coord.git -b middleware
>   ```
>
> * 进入到代码文件夹，执行脚本将代码发布到maven本地仓库
    >
...
>   <dependency>
>     <groupId>repchain.interface.cooperation</groupId>
>     <artifactId>Interface-Cooperation-Middleware</artifactId>
>     <version>1.0-SNAPSHOT</version>
>   </dependency>
>   ```
    >
    ...
    >
    >   ```gradle
>       implementation 'repchain.interface.cooperation:Interface-Cooperation-Middleware:1.0-SNAPSHOT'
>   ```
>
>
## 二、接口协同所需代码
