package repchain.inter.cooperation.middleware.async.single.request;
...
public class AsyncClient {
     ...
     **/
    public static Header customHeader(Service service, String cid, boolean isEnd, Signature signature, int seq) {
        return Header
                .builder()
                // 请求Id
                .cid(cid)
