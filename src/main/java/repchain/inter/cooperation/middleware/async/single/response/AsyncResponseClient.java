package repchain.inter.cooperation.middleware.async.single.response;
...
public class AsyncResponseClient {
     ...
     * @params [service (yml文件读取，包含请求方id和调用方id),   isEnd （是否为结束调用存证）,signature (签名数据)，header (暂存的请求方的Header)]
     **/
