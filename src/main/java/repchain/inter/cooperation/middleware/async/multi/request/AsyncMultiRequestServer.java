package repchain.inter.cooperation.middleware.async.multi.request;
 ...
 */
public class AsyncMultiRequestServer {

    private static final Logger logger = LoggerFactory.getLogger(AsyncMultiRequestServer.class);
    ...
    public static void main(String[] args) {
        ...
        HttpUtil.createServer(8889)
                .addAction("/callback", AsyncMultiRequestServer::callback)
                .start();
    }
