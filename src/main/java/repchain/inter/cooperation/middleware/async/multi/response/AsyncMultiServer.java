package repchain.inter.cooperation.middleware.async.multi.response;
...
import repchain.inter.cooperation.middleware.utils.ECSignatureUtil;
...
public class AsyncMultiServer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AsyncMultiServer.class);
    ...
    public static void main(String[] args) {
        ...
        HttpUtil.createServer(8888)
                ...
                .addAction("/infoList", AsyncMultiServer::getInfoList)
                .start();
    }
    ...
    public static void getInfoList(HttpServerRequest request, HttpServerResponse response) {
        ...
        try {
            ...
            if (validAuth(header)) {
                ...
                header.setData(JSONUtil.toJsonStr(MapUtil.builder(new HashMap<String, Object>(2))
                        .put("pageNo", pageNo)
